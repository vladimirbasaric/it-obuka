...
$target_file = "myUploads/".basename($_FILES['fileToUpload']['name']);
...
if(in_array($file_ext,$expensions) === false){
	echo "Nije dozvoljena odabrana ekstenzija dokumenta (extension not allowed, please choose a HTML file.)";
	$uploadOk = 0;
}
...
echo "Ekstenzija fajla: ".$file_ext."<br>";
echo "Tip fajla: ".$file_type."<br>";
echo "Kod greske: ".$error_code."<br>";
}
?>