            ...
            if ($result == false) {
                ...
                for ($i = 0; $i < $number_of_posts; $i++) {
                    ...
                    */
                    ...
                    /* 
                    Funkcija substr izdvaja iz zadate niske podnisku pocevsi od pozicije koja se zadaje kao 
                    drugi argument u duzini koja se zadaje kao treci argument. */

                    $short_content = substr($full_content, 0, 25);
